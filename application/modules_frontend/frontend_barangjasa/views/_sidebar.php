<div class="widget">
  ...
  <div class="widget-content">
    <div class="shortcuts"> 
      <a href="<?php echo site_url('barang-jasa'); ?>" class="shortcut" style="width: 100%;">
    ...
    <!-- /shortcuts -->
    <div class="shortcuts"> 
      <a href="<?php echo site_url('barang-jasa/add'); ?>" class="shortcut" style="width: 100%;">
    ...
    <!-- /shortcuts -->
    <div class="shortcuts"> 
      <a href="<?php echo site_url('barang-jasa/persediaan'); ?>" class="shortcut" style="width: 100%;">
        <i class="shortcut-icon icon-file"></i>
        <span class="shortcut-label">Persediaan</span> 
      </a>
    </div>
    <!-- /shortcuts --> 
