                    ...
                    <div id="collapseone" class="accordion-body collapse">
                      <div class="accordion-inner">
                        <div>
                          ...
                          <span class="shortcut-label"><a href="print_general_report.html" class="el-fil">Buku Besar</a><br/></span>
                          <!-- buku besar -->
                          <div class="filter">
                            <select name="sl_periode_bulan_1" class="sl_periode_bulan_1" style="width:initial;padding:3px;">
                              <option value="">---Pilih Akun----</option>
                              <?php foreach($data_source as $key => $value): ?>
                            ...
                            <button class="btn_laporan" name="btn_laporan" data-type="keuangan_general_report" style="vertical-align: top;padding: 3px;">Generate</button>
                          </div>
                          <!-- buku besar -->
                          <i class="shortcut-icon icon-tag"></i>
                          <span class="shortcut-label"><a href="print_general_report.html" class="el-fil">Laporan Bulanan Cash Flow</a><br/></span>
                          <!-- laporan bulanan cash flow -->
                          <div class="filter"> 
                            <select name="sl_periode_bulan_2" class="sl_periode_bulan_2" style="width:initial;padding:3px;">
                              <option value="">---Pilih Bulan----</option>
                              <?php foreach($static_data_source['daftar_bulan'] as $key => $value): ?>
                            ...
                            <button class="btn_laporan" name="btn_laporan" data-type="laporan_bulanan_cash_flow_report" style="vertical-align: top;padding: 3px;">Generate</button>
                          </div>
                          <!-- laporan bulanan cash flow -->
                        </div>
                      </div>
    ...
    $('.btn_laporan').click(function(e){
      ...
      switch(type){
        ...
        case "keuangan_general_report" : 
          ...
          break;
        case "laporan_bulanan_cash_flow_report" : 
          url = '<?php echo site_url("laporan/laporan_bulanan_cash_flow_report"); ?>?periode_bulan_1='+periode_bulan_1+'&periode_bulan_2='+periode_bulan_2+'&periode_tahun='+periode_tahun;
          break;
