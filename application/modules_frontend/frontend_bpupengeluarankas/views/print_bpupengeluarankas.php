                                    ...
                                    <div class="rgt" style="width:300px;">
                                        <table class="no-border">
                                            <tr>
                                                <td width="25%">No.</td>
                                                <td width="5%">:</td>
                                                <td><div class="blck" style="border-bottom:thin dotted black;"><?php echo $detail['bpupglrnkas_nobukti']; ?></div></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="row blck ovrlw rltv">
                                    <div class="rgt" style="width:300px;">
                                        <div style="border: solid 1px; padding:10px;">
                                            Rp. <?php echo number_format ($detail['bpupglrnkas_jumlah']); ?>
                                        </div>
                                    </div>
                                </div>
                            </td>
                                        ...
                                        <td>
                                            <table class="blck no-border">
                                                <tr>
                                                    ...
                                                    <td><div class="blck" style="border-bottom:thin dotted black;"> <?php echo terbilang($detail['bpupglrnkas_jumlah']); ?> rupiah </div></td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>Untuk keperluan</span></td>
                                                    <td width="5%" class="delimiter">:</td>
                                                    <td><div class="blck" style="border-bottom:thin dotted black;"> <?php echo $detail['bpupglrnkas_untuk']; ?> </div></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%">
                                            <table style="width: 300px;margin: auto;">
                                                <tr>
                                                    <td>Bekasi, <?php echo $detail['bpupglrnkas_tanggal'];?></td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php echo $detail['bpupglrnkas_penerima'];?>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
