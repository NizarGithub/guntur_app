            ...
            <?php echo form_open_multipart($module_base_url_permintaan . '/edit/' . $detail['ppmt_id']);?>
                ...
                <div class="form-fields">
                  ...
                  <div class="field">
                    ...
                    <select name="ppmt_ppnw_id" id="ppmt_ppnw_id" required />
                      ...
                      <?php foreach($option_referensi as $value): ?>
                        <option value="<?php echo $value['ppnw_id']; ?>" <?php echo ($detail['ppmt_ppnw_id'] == $value['ppnw_id'] ? 'selected' : ''); ?>><?php echo $value['ppnw_no_penawaran']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div> <!-- /field -->
                  ...
                  <div class="field">
                    ...
                    <input type="text" name="ppmt_noso" placeholder="No Permintaan" value="<?php echo $detail['ppmt_noso']; ?>" />
                  </div> <!-- /field -->
                ...
                <div class="field">
                  ...
                  <div class="field">
                    ...
                    <input class="numberformat" type="text" name="ppmt_uangmuka" value="<?php echo $detail['ppmt_uangmuka']; ?>"/>
                  </div> <!-- /field -->
