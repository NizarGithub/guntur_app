              ...
              <?php echo form_open_multipart($module_base_url_berita_acara. '/edit/' . $detail['pbcr_id']);?>
                ...
                <div class="form-fields">
                  ...
                  <div class="field">
                    ...
                    <select name="pbcr_pjkw_id" id="pbcr_pjkw_id" required />
                      ...
                      <?php foreach($option_referensi as $value): ?>
                        <option value="<?php echo $value['pjkw_id']; ?>" <?php echo ($detail['pbcr_pjkw_id'] == $value['pjkw_id'] ? 'selected' : ''); ?>><?php echo $value['pjkw_no']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div> <!-- /field -->
                  ...
                  <div class="field">
                    ...
                    <input id="pbcr_deskripsi" name="pbcr_deskripsi" value="<?php echo $detail['pbcr_deskripsi']; ?>" />
                  </div> <!-- /field -->

                  <div class="field">
                    <label for="pbcr_desperjanjian">Tanggal Perjanjian</label>
                    <input id="pbcr_tglperjanjian" class="date-picker" name="pbcr_tglperjanjian" value="<?php echo $detail['pbcr_tglperjanjian']; ?>" />
                  </div> <!-- /field -->
