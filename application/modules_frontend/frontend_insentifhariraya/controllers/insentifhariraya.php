...
class Insentifhariraya extends MY_Frontend {
	...
	function __construct(){
		...
		$this->load->model('frontend_insentifhariraya/crud_insentifhariraya', 'crud');
		$this->_data['module_base_url'] = site_url('insentif-hari-raya');
	...
	function add() {
		...
		$this->template->set('title', 'Tambah Insentif Hari Raya | Aplikasi Keuangan - PT. Putra Bahari Mandiri');
		$this->template->set('assets', $this->_data['assets']);
