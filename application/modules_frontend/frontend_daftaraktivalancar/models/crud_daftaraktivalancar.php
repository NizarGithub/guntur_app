...
class Crud_daftaraktivalancar extends CI_Model {
	//--------base---------------
	...
	function get_row(){
		return $this->db->get('aktivalancar')->row_array();
	}

	function get_all(){
		return $this->db->get('aktivalancar')->result_array();
	}

	function posts($data){
		return $this->db->insert('aktivalancar', $data);
	}

	function puts($data){
		return $this->db->update('aktivalancar', $data);
	}

	function delete($data){
		return $this->db->delete('aktivalancar', $data);
	}
}  