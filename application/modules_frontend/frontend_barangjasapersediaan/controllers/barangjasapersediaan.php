...
class Barangjasapersediaan extends MY_Frontend {
	...
	function __construct(){
		...
		$this->load->model('frontend_barangjasapersediaan/crud_barangjasa', 'crud');
		$this->load->model('frontend_vendor/crud_vendor', 'crud_vendor');
		$this->_data['module_base_url'] = site_url('barangjasa-persediaan');
