              ...
              <form action="<?php echo ($module_base_url . '/edit/' . $detail['brjs_id']); ?>" method="post">
                ...
                <div class="form-fields">
                  ...
                  <div class="field">
                    ...
                    <div class="rd-inline">
                      <label><input type="radio" name="brjs_over_project" value="1" <?php echo ($detail['brjs_over_project'] == 1) ? 'checked' : ''; ?> /> Ya</label>
                      <label><input type="radio" name="brjs_over_project" value="0" <?php echo ($detail['brjs_over_project'] == 0) ? 'checked' : ''; ?> /> Tidak</label>
                    </div>
                  </div> <!-- /field -->
