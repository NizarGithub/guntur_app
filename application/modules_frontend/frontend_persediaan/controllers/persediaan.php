...
class Persediaan extends MY_Frontend {
	...
	function __construct(){
		...
		$this->load->model('frontend_persediaan_barang/crud_persediaan', 'crud');
		$this->_data['module_base_url'] = site_url('persediaan');
	...
	function index() {
		...
		$this->template->set('title', 'Persediaan Barang | Aplikasi Keuangan - PT. Putra Bahari Mandiri');
	...
	function add() {
		...
		$this->template->set('title', 'Tambah Persediaan Barang | Aplikasi Keuangan - PT. Putra Bahari Mandiri');
		$this->template->set('assets', $this->_data['assets']);
