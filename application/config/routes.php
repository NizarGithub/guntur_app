...
//route daftar aktiva lancar
$route['daftar-aktiva-lancar'] = "frontend_daftaraktivalancar/daftaraktivalancar";
$route['daftar-aktiva-lancar/add'] = "frontend_daftaraktivalancar/daftaraktivalancar/add";
$route['daftar-aktiva-lancar/edit/(:any)'] = "frontend_daftaraktivalancar/daftaraktivalancar/edit/$1";
$route['daftar-aktiva-lancar/delete/(:any)'] = "frontend_daftaraktivalancar/daftaraktivalancar/delete/$1";
...
$route['barang-jasa/persediaan'] = "frontend_barangjasa/persediaan";
$route['barang-jasa/persediaan/add'] = "frontend_barangjasa/persediaan/add";
$route['barang-jasa/persediaan/edit/(:any)'] = "frontend_barangjasa/persediaan/edit/$1";
$route['barang-jasa/persediaan/delete/(:any)'] = "frontend_barangjasa/persediaan/delete/$1";

//route barang jasa 1
//$route['barang-jasapersediaan'] = "frontend_barangjasapersedian/barangjasapersedian";
//$route['barang-jasa/add'] = "frontend_barangjasa/barangjasa/add";
//$route['barang-jasa/edit/(:any)'] = "frontend_barangjasa/barangjasa/edit/$1";
//$route['barang-jasa/delete/(:any)'] = "frontend_barangjasa/barangjasa/delete/$1";
//$route['barang-jasa/data_barang/(:any)'] = "frontend_barangjasa/barangjasa/data_barang/$1";
...
//route slipgaji
$route['slip-gaji'] = "frontend_slipgaji/slipgaji";
$route['slip-gaji/add'] = "frontend_slipgaji/slipgaji/add";
$route['slip-gaji/edit/(:any)'] = "frontend_slipgaji/slipgaji/edit/$1";
$route['slip-gaji/delete/(:any)'] = "frontend_slipgaji/slipgaji/delete/$1";
$route['slip-gaji/terbilang/(:any)'] = "frontend_slipgaji/slipgaji/terbilang/$1";


//route Penerimaan Kas
$route['bpu-penerimaankas'] = "frontend_bpupenerimaankas/bpupenerimaankas";
$route['bpu-penerimaankas/add'] = "frontend_bpupenerimaankas/bpupenerimaankas/add";
$route['bpu-penerimaankas/edit/(:any)'] = "frontend_bpupenerimaankas/bpupenerimaankas/edit/$1";
$route['bpu-penerimaankas/delete/(:any)'] = "frontend_bpupenerimaankas/bpupenerimaankas/delete/$1";
$route['bpu-penerimaankas/terbilang/(:any)'] = "frontend_bpupenerimaankas/bpupenerimaankas/terbilang/$1";
$route['bpu-penerimaankas/pdf/(:any)'] = "frontend_bpupenerimaankas/bpupenerimaankas/pdf/$1";

//route Pengeluaran Kas
$route['bpu-pengeluarankas'] = "frontend_bpupengeluarankas/bpupengeluarankas";
$route['bpu-pengeluarankas/add'] = "frontend_bpupengeluarankas/bpupengeluarankas/add";
$route['bpu-pengeluarankas/edit/(:any)'] = "frontend_bpupengeluarankas/bpupengeluarankas/edit/$1";
$route['bpu-pengeluarankas/delete/(:any)'] = "frontend_bpupengeluarankas/bpupengeluarankas/delete/$1";
$route['bpu-pengeluarankas/terbilang/(:any)'] = "frontend_bpupengeluarankas/bpupengeluarankas/terbilang/$1";
$route['bpu-pengeluarankas/pdf/(:any)'] = "frontend_bpupengeluarankas/bpupengeluarankas/pdf/$1";

//route Insentif hari raya
$route['insentif-hari-raya'] = "frontend_insentifhariraya/insentifhariraya";
$route['insentif-hari-raya/add'] = "frontend_insentifhariraya/insentifhariraya/add";
$route['insentif-hari-raya/edit/(:any)'] = "frontend_insentifhariraya/insentifhariraya/edit/$1";
$route['insentif-hari-raya/delete/(:any)'] = "frontend_insentifhariraya/insentifhariraya/delete/$1";
$route['insentif-hari-raya/terbilang/(:any)'] = "frontend_insentifhariraya/insentifhariraya/terbilang/$1";
...
$route['laporan/laporan_bulanan_cash_flow_report'] = "frontend_laporan/laporan/laporan_bulanan_cash_flow_report";
...
//route bukti pembayaran penjualan
