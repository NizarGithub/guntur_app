            ...
            <ul class="mainnav">
                ...
                <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-list-ul"></i><span>Daftar</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['daftar-aktiva-lancar']['read']))): ?><li><a href="<?php echo site_url('daftar-aktiva-lancar'); ?>">Aktiva Lancar</a></li><?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <?php if(($this->session->userdata('userid') == 1) OR ((!empty($role_access['bpu-penerimaankas']['read'])) OR (!empty($role_access['bpu-pengeluarankas']['read'])))): ?>
                <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-paste"></i><span>BPU</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['bpu-penerimaankas']['read']))): ?><li><a href="<?php echo site_url('bpu-penerimaankas'); ?>">Penerimaan Kas</a></li><?php endif; ?>
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['bpu-pengeluarankas']['read']))): ?><li><a href="<?php echo site_url('bpu-pengeluarankas'); ?>">Pengeluaran Kas</a></li><?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>


                <?php if(($this->session->userdata('userid') == 1) OR ((!empty($role_access['bpu-penerimaankas']['read'])) OR (!empty($role_access['mata-uang']['read'])))): ?>
                <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-paste"></i><span>Laporan Absen</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['insentif-hari-raya']['read']))): ?><li><a href="http://localhost:8080/aplikasi/insentif_hariraya/">Insentif Hari Raya</a></li><?php endif; ?>
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['bpu-pengeluarankas']['read']))): ?><li><a href="http://localhost:8080/aplikasi/absen_tagihanOT/">Absen Tagihan OT</a></li><?php endif; ?>
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['insentif-hari-raya']['read']))): ?><li><a href="http://localhost:8080/aplikasi/absen_gajian/">Absen Gajian</a></li><?php endif; ?>
                        <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['insentif-hari-raya']['read']))): ?><li><a href="http://localhost:8080/aplikasi/absen_tagihan/">Absen Tagihan</a></li><?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['laporan']['read']))): ?><li><a href="<?php echo site_url('laporan'); ?>"><i class="icon-paste"></i><span>Laporan</span></a></li><?php endif; ?>
				  ...
				  <!-- <?php if(($this->session->userdata('userid') == 1) OR (!empty($role_access['laporan']['read']))): ?><li><a href="<?php echo site_url('halaman'); ?>"><i class="icon-paste"></i><span>Export</span></a></li><?php endif; ?>-->
