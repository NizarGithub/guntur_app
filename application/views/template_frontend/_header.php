...
<html lang="en">
    ...
    <script src="https://cdn.datatables.net/1.7.2/js/jquery.dataTables.min.js" type="text/javascript"></script>
    <script type="text/javascript">
      $(document).ready(function() {
        $('.widget-content>table').DataTable();
        $('a[title="delete"]').click(function(){
            var cfm = confirm('Hapus data ini?');
            if(!cfm) return false;
        });
        $('#tblData').DataTable({
            'ordering': false
