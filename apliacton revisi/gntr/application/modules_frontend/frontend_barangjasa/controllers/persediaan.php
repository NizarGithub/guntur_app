...
class Persediaan extends MY_Frontend {
	...
	private function do_add() {
		...
		$this->form_validation->set_rules('psdbrg_total', 'Total', 'trim|htmlspecialchars|encode_php_tags|prep_for_form|required|xss_clean');
		...
		if($this->form_validation->run()) {
			$db_data = array(
				...
				'psdbrg_total' => clear_numberformat($this->input->post('psdbrg_total')),
